...
*     page.tsx - та страница которая открывается при запросе "/"
...
*     course
*         page.tsx - код страницы course в целом
*         [id]
*             page.tsx - код страницы course, контретно одного курса
...
Frontend это не только, но во многом о дизайне. О внешнем виде приложения. Основная вёрстка пишется в файлах page.tsx. Но как react упрощает вёрстку?
